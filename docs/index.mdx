...
- [Contributors](/contributors/index) collects the project rules, testing
...
- [Reference](/reference/index): command, config, formula, and provider
  lookup docs.
- [Architecture](/architecture/index): how Gas City works today.
- [Design](/design/index): proposals, accepted plans, and historical design
  context.
- [Archive](/archive/index): audits, backlogs, roadmaps, and research notes
