...
1. Read [Nine Concepts Overview](../architecture/nine-concepts.md).
2. Read [Config System](../architecture/config.md).
3. Read [Orders](../architecture/orders.md) and mentally remap "plugins" to
   "orders".
4. Read [Formulas & Molecules](../architecture/formulas.md) and remember that
