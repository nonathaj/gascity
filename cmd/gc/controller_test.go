...
func TestControllerLoopCancel(t *testing.T) {
	...
	controllerLoop(ctx, time.Hour, cfg, "test", "", nil, buildFn, sp, nil, nil, nil, nil, events.Discard, "gc-test-", nil, nil, &stdout, &stderr)
...
func TestControllerLoopTick(t *testing.T) {
	...
	controllerLoop(ctx, 10*time.Millisecond, cfg, "test", "", nil, buildFn, sp, nil, nil, nil, nil, events.Discard, "gc-test-", nil, nil, &stdout, &stderr)
...
func TestControllerReloadsConfig(t *testing.T) {
	...
	go controllerLoop(ctx, 20*time.Millisecond, cfg, "test", tomlPath, nil,
		buildFn, sp, nil, nil, nil, nil, events.Discard, "gc-test-", nil, nil, &stdout, &stderr)
