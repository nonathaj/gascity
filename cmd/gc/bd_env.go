...
func resolveBdBinaryForScope(cityPath, scopeRoot string) (string, error) {
	...
	// execshim.LookPath, not exec.LookPath: it tries exec.LookPath first and
	// then probes the Git-for-Windows coreutils dirs, which is how a bare
	// tool name resolves to bd.exe on Windows.
